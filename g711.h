...
//Encode
int G711EnCode(char* pCodecBits, char* pBuffer, int nBufferSize, int type)
{
    if(pCodecBits == NULL || pBuffer == NULL || nBufferSize <= 0)
        return -1;
...
//Decode
int G711Decode(char* pRawData, char* pBuffer, int nBufferSize, int type)
{
    if(pRawData == NULL || pBuffer == NULL || nBufferSize <= 0)
        return -1;
